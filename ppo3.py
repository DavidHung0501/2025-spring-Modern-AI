...
for idx, agent in enumerate(agents):
    print(f"Training agent {idx+1}/{num_agents}")
    ...
    # 取得每個 agent 最後績效
    agent_performances.append(env.net_worth)
...
print(f"\nToday's suggested action (Weighted Soft Voting): {action_dict[final_action]}")
